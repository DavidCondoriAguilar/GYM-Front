  ...
  return (
    <Router>
      <div className="flex h-screen bg-gray-900 text-gray-100 overflow-hidden">
        ...
        >
          {/* Top Bar */}
          <header className="bg-gray-800 border-b border-gray-700 shadow-sm z-40">
            <div className="flex items-center justify-between p-4">
              <button 
                onClick={toggleMenu}
                className="p-2 rounded-lg text-gray-300 hover:bg-gray-700 transition-colors md:hidden"
