...
export default function PaymentPage() {
  ...
  // Estado para controlar la vista (tabla o detalle)
  const [view, setView] = useState('table');

  // Función para manejar la vista
    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* New Payments Card */}
          <div className="bg-blue-900 rounded-xl p-6 hover:bg-blue-800 transition-all duration-300 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-blue-200">Nuevos Pagos Hoy</h3>
                <p className="text-4xl font-bold text-blue-200 mt-2">{newPaymentsCount}</p>
              </div>
          ...
          <div className="bg-green-900 rounded-xl p-6 hover:bg-green-800 transition-all duration-300 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-green-200">Pagos Activos</h3>
                <p className="text-4xl font-bold text-green-200 mt-2">{activePaymentsCount}</p>
              </div>
          ...
          <div className="bg-yellow-900 rounded-xl p-6 hover:bg-yellow-800 transition-all duration-300 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-yellow-200">Ingreso Mensual</h3>
                <p className="text-4xl font-bold text-yellow-200 mt-2">S/. {monthlyRevenue.toFixed(2)}</p>
              </div>
              <div className="p-3 bg-yellow-800 rounded-full">
                <CurrencyDollarIcon className="h-6 w-6 text-yellow-200" />
              </div>
            </div>
          </div>
        </div>
