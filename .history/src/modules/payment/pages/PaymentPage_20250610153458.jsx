    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-900">
        <div className="text-center">
          <p className="text-red-400 text-lg mb-2">Error al cargar los datos</p>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-800 rounded-xl p-6">
              ...
              <p className="text-3xl font-bold text-green-400 mt-2">{newPaymentsCount}</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6">
              <h3 className="text-sm font-medium text-gray-400">Pagos Activos</h3>
              <p className="text-3xl font-bold text-blue-400 mt-2">{activePaymentsCount}</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6">
              <h3 className="text-sm font-medium text-gray-400">Ingreso Mensual</h3>
              <p className="text-3xl font-bold text-yellow-400 mt-2">S/{monthlyRevenue}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl overflow-hidden">
          <table className="min-w-full divide-y divide-gray-700">
            <thead>
              <tr>
                <th className="px-6 py-3 bg-gray-700 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                  ID
                </th>
                <th className="px-6 py-3 bg-gray-700 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                  Miembro
                ...
                <th className="px-6 py-3 bg-gray-700 text-right text-xs font-medium text-gray-400 uppercase tracking-wider">
                  Acciones
                </th>
              </tr>
            </thead>
